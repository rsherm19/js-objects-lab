...
game.party.push(pokemon[0], pokemon[3], pokemon[24]);
...
//   object = pokemon[object.number]
// }

game.party.forEach((object, i) => {
  game.party[i] = pokemon[object.number]
});
